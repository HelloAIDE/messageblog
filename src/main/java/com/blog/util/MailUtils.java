...
public class MailUtils {
    ...
    public static void main(String[] args) {
        ...
        // 设置发件人地址、收件人地址和邮件标题
        cn.setAddress("difan_jcw@163.com", "difanjcw@qq.com", "一个带附件的JavaMail邮件");
        // 设置要发送附件的位置和标题
        cn.setAffix("D:/20161225135120.sql", "20161225135120.sql");
        /**
         * 设置smtp服务器以及邮箱的帐号和密码
         * 用QQ 邮箱作为发生者不好使 （原因不明）
         ...
         */
        cn.send("smtp.163.com", "difan_jcw@163.com", "10086com");
